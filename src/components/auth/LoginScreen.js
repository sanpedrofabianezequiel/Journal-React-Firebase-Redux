...
import { loginFunction, starLoginEmailPasswordMiddleware, startGoogleLogin } from '../../actions/auth';
import { googleAuthProvider } from '../../firabase/firebase-config';
...
export const LoginScreen = () => {
    ...
    const handleLogin = (e)=>{
       ...
       // console.table(email,password);
        dispacth( starLoginEmailPasswordMiddleware(email,password));
    }
